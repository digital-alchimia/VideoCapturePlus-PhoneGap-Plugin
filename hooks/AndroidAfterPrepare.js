module.exports = function(ctx) {
    ...
    if ( manifestPath !== null ) {
        ...
        var appId = "cordova-plugin-video-capture-plus";
        var appNode = doc.getroot().find( "./application" );

        if ( ! appNode.find( "provider[@android:authorities=\"" + appId + ".provider\"]" ) ) {
            var child = et.XML(
                "<provider android:name=\"nl.xservices.plugins.videocaptureplus.FileProvider\" android:authorities=\"" + appId + ".provider\" android:exported=\"false\" android:grantUriPermissions=\"true\">" +
                    "<meta-data android:name=\"android.support.FILE_PROVIDER_PATHS\" android:resource=\"@xml/videocaptureplus_provider_paths\" />" +
                "</provider>"
            );
